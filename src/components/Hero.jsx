    ...
    <section className="relative isolate">
      ...
      <div className="mx-auto max-w-6xl px-4 mt-6 md:mt-8">
        <h1 className="text-3xl md:text-5xl font-bold tracking-tight text-white">
          FiveM NUI Testing Lab
        </h1>
        <p className="mt-3 md:mt-4 text-sm md:text-base text-white/70 max-w-2xl">
          Upload, preview, edit, and debug your NUI (HTML/CSS/JS) with a simulated FiveM environment.
        </p>

        <div className="mt-6 grid grid-cols-1 sm:grid-cols-3 gap-3">
          <div className="flex items-center gap-3 rounded-xl bg-white/5 p-3 ring-1 ring-white/10">
            <Zap className="h-5 w-5 text-yellow-400" />
            <span className="text-sm text-white/80">Live NUI preview sandbox</span>
          </div>
          <div className="flex items-center gap-3 rounded-xl bg-white/5 p-3 ring-1 ring-white/10">
            <Shield className="h-5 w-5 text-emerald-400" />
            <span className="text-sm text-white/80">Fake FiveM API & callbacks</span>
          </div>
          <div className="flex items-center gap-3 rounded-xl bg-white/5 p-3 ring-1 ring-white/10">
            <Rocket className="h-5 w-5 text-indigo-400" />
            <span className="text-sm text-white/80">Edit & export updated UI</span>
          </div>
        </div>
      </div>
    </section>
